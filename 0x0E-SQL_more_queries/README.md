...
~~~~
root@ubuntu:/#~$ echo "CREATE DATABASE hbtn_0d_tvshows;" | mysql -uroot -p
Enter password: 
root@ubuntu:/#~$ curl "https://s3.amazonaws.com/intranet-projects-files/holbertonschool-higher-level_programming+/274/hbtn_0d_tvshows.sql" -s | mysql -uroot -p hbtn_0d_tvshows
Enter password: 
root@ubuntu:/#~$ echo "SELECT * FROM tv_genres" | mysql -uroot -p hbtn_0d_tvshows
Enter password: 
id  name
1   Drama
2   Mystery
...
root@ubuntu:/#~$
~~~~
![joins](./bc2575fee3303b731031.png)
## Tasks
### 0. My privileges!
